! function(n) {
    ...
    t.css("width", s), e.each(function(e, t) {
        n(this).on("click", function(e) {
            o(e.target), n(this).addClass("active").siblings().removeClass("active")
        })
    }), n("#theme-navbar .f-nav .f-nav-tab").on("click", function(e) {
        const t = n(this).data("filter");
        n("#theme-navbar .mega-menu .f-area." + t).siblings().hide(), n("#theme-navbar .mega-menu .f-area." + t).show()
    ...
    a.css("width", c), i.each(function(e, t) {
        n(this).on("click", function(e) {
            o(e.target), n(this).addClass("active").siblings().removeClass("active")
        })
    }), n("#theme-navbar .nav-bottom .links .link:not(#side-box-btn)").on("click", function() {
        n(".open-side-box")[0] && n("#side-box").removeClass("open-side-box")
    }), n(document).mouseup(function(e) {
        const t = n("#side-box");
        t.is(e.target) || 0 !== t.has(e.target).length || t.removeClass("open-side-box")
        ...
        t.is(e.target) || 0 !== t.has(e.target).length || t.removeClass("open-dropdown-menu")
        ...
        n(this).addClass("active-theme").siblings().removeClass("active-theme"), "light-theme-btn" === n(this).attr("id") ? n("body").addClass("light-theme") : "dark-theme-btn" === n(this).attr("id") && n("body").removeClass("light-theme")
        ...
        n(this).parent().toggleClass("open").siblings().removeClass("open"), n(this).parent().hasClass("open") ? (n(this).parent().find(".q-b").slideDown(), n(this).parent().siblings().find(".q-b").slideUp()) : n(this).parent().find(".q-b").slideUp()
    })
}(jQuery);